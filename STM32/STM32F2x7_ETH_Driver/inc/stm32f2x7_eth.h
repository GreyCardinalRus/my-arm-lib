...
#define PHY_PHYID1                       2          /*!< Tranceiver PHY Identifier 1 Register */  //STEVAL-PCC010V2 
#define PHY_TSTAT                        28          /*!<  10Base-T status register */  //STEVAL-PCC010V2 

#define ST_OUI_H                         0x0203     /*!< ST's OUI higher bytes as stored in PHYID1 Register */ //STEVAL-PCC010V2 
...
/** @defgroup 10Base-T_error_and_general_status_register 
  * @{
  */ 
//STEVAL-PCC010V2 
#define PHY_MDIX_Disable_mask           ((uint16_t)0xF7FF)      /*!<  Setting this bit disables auto-detection and negotiation of MDIX. Clearing this bit enables auto-MDIX.*/
